...
function getAll() {
	...
	document.getElementById("cat-watch").classList.remove("active");
	document.getElementById("cat-airpod").classList.remove("active");
	document.getElementById("cat-headphone").classList.remove("active");
...
function getWatches() {
	...
	document.getElementById("cat-headphone").classList.remove("active");
	document.getElementById('cat-mob').classList.remove('active');
	document.getElementById("cat-watch").classList.add("active");
}
function getAirpods() {
	renderProducts('airpod');
	document.getElementById('cat-all').classList.remove('active');
	document.getElementById('cat-lap').classList.remove('active');
	document.getElementById("cat-watch").classList.remove("active");
	document.getElementById("cat-headphone").classList.remove("active");
	document.getElementById('cat-mob').classList.remove('active');
	document.getElementById("cat-airpod").classList.add("active");
}
function getHeadphones() {
	...
	document.getElementById('cat-mob').classList.remove('active');
	document.getElementById("cat-airpod").classList.remove("active");
	document.getElementById("cat-headphone").classList.add("active");
}
